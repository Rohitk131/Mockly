...
export const AuroraBackground = ({
  ...
  return (
    <main>
      <div
        className={cn(
          "relative flex flex-col  h-[200vh] items-center  bg-zinc-900  text-slate-950 transition-bg",
          className
        )}
        {...props}
      >
        <div className="absolute inset-0 overflow-hidden">
          <div
            ...
            [--aurora:repeating-linear-gradient(100deg,var(--indigo-500)_10%,var(--purple-400)_20%,var(--blue-500)_30%,var(--green-400)_40%,var(--blue-300)_30%)]
